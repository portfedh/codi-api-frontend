export default function WhatIsCodiSection() {
  return (
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-2">Dinero al Instante</h3>
            <p className="text-gray-600">
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-2">Trazabilidad Total</h3>
            <p className="text-gray-600">
              Cada pago incluye un ID de confirmación único que te permite identificar y rastrear
              cada transacción de forma sencilla y confiable.
            </p>
          </div>
        </div>
      </div>
