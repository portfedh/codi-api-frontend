        ...
        {activeTab === 'uptime' && (
          <div className="text-center py-12">
            <p className="text-gray-600 mb-6">
              Consulta el estado y disponibilidad de la API de Bite Size (no del servicio CoDi de Banco de México)
            </p>
            ...
            >
              Ver Historial de Disponibilidad de la API de Bite Size
